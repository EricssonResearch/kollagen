...
inline nlohmann::json open_json(const std::string& filename){
  std::ifstream f(filename);
  nlohmann::json data = nlohmann::json::parse(f);
  return data;
}

inline std::vector<AgentParams> parse_agent_params(const nlohmann::json& data){
...
inline std::vector<LCParams> parse_lc_params(const nlohmann::json& data){
...
inline InterLCParams parse_inter_lc_params(const nlohmann::json& data){
...
inline DataGeneratorParams get_params_from_json(const nlohmann::json& data){
  ...
  params.exact_information_matrix = data.at("exact_information_matrix");
  return params;
}
